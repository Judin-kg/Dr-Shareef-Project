...
// import "../pages/About.css";
// import image from "../assets/Dr.PNG";
// import vedio from "../assets/DR A M SHAREEF BNI FOCUS.mp4"
...
//   =============================== */
//   // useEffect(() => {
//   //   const text = "About Dr. A M Shareef";
//   //   let index = 0;

//   //   const type = () => {
//   //     if (index < text.length) {
//   //       titleRef.current.innerHTML += text.charAt(index);
//   //       index++;
//   //       setTimeout(type, 70);
//   //     }
//   //   };
...
import React, { useEffect, useRef, useState } from "react";
import "../pages/About.css";
import imageFallback from "../assets/Dr.PNG";
import bgImage from "../assets/img.webp";
...
export default function About() {
  ...
  if (loading) return <section className="about-section">Loading...</section>;
    ...
    >
      ...
      <div className="about-wrapper">
        ...
        <div className="about-text">
          ...
          {/* Optional extra static sections */}
          <div className="about-block fade-in delay">
            <h3>Education & Early Career</h3>
            <p>
              Dr. Shareef’s journey began with a strong foundation in dental science,
              where he developed exceptional clinical skills and a patient-centric approach.
            </p>
          </div>
